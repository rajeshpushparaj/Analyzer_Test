 ...
 *       class=&quot;org.springframework.security.ldap.authentication.CustomLdapAuthenticationProvider&quot;&gt;
 *     &lt;constructor-arg&gt;
		...
		try {
			...
			if (this.hideUserNotFoundExceptions) {
				throw new BadCredentialsException(this.messages.getMessage(
						"CustomLdapAuthenticationProvider.badCredentials", "Bad credentials"));
			}
			else {
				throw notFound;
			}
