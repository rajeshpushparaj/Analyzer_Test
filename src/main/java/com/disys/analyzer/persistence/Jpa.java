...
import com.disys.analyzer.config.WebApplicationInitializer;
import com.disys.analyzer.config.dialect.SQLServerDBDialect;

@Configuration
@EnableJpaRepositories(basePackages = "com.disys.analyzer")
public class Jpa {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory( //
		...
		log.debug("Loading JPA EntityManagerFactory.");
	...
	public String[] packagesToScan() {
		return WebApplicationInitializer.class.getAnnotation(
				ComponentScan.class).basePackages();
	}

	/*
	 * @Bean(autowire = Autowire.BY_NAME) public Database jpaVendorDatabase() {
	 * return Database.H2; }
	 */
	...
	public enum Hbm2Ddl {
		NONE("none"), VALIDATE("validate"), UPDATE("update"), CREATE("create"), CREATE_AND_DROP(
				"create-drop");
...
//		return SQLServer2008Dialect.class.getName();
		return SQLServerDBDialect.class.getName();
	}
	...
	public Map<String, ?> jpaPropertiesMap() {
		...
		bean.put("hibernate.id.new_generator_mappings", false);
		return bean;
	}
